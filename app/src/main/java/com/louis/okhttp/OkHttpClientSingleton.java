...
import com.louis.okhttp.bean.BaseBean;
import com.louis.okhttp.bean.BaseListBean;
import com.louis.okhttp.bean.OthersBean;
import com.louis.okhttp.callback.GsonOkHttpCallback;
import com.louis.okhttp.callback.SimpleGsonOkHttpCallback;
import com.louis.okhttp.callback.SimpleStringOkHttpCallback;
import com.louis.okhttp.callback.StringOkHttpCallback;
import com.louis.okhttp.util.MD5Util;
import com.louis.okhttp.util.ParamsUtil;
import com.louis.okhttp.util.UrlUtil;
...
public class OkHttpClientSingleton {
   ...
   private OkHttpClientSingleton() {
     ...
     * @param url
     */
    public  void doGetAsyncFileWithProgress(String url,Callback responseCallback){
        ...
        private Source source(Source source) {
            return new ForwardingSource(source) {
                ...
                @Override public long read(Buffer sink, long byteCount) throws IOException {
                    ...
                    onDownloadProgressListener.onDownloadloadProgress(totalBytesRead, responseBody.contentLength(), bytesRead == -1);
                    return bytesRead;
                }
            };
        }
